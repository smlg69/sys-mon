...
import { CCTVDataPoint } from "../../types/cctv";

interface CCTVChartProps {
  data: CCTVDataPoint[];
  title: string;
  color?: string;
  unit?: string;
...
export const CCTVChart: React.FC<CCTVChartProps> = React.memo(
  ({ data, title, color = "#1976d2", unit = "ед.", isLoading = false }) => {
